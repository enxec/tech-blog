...
- 제 1 정규형(1NF)
  ...
  >
  >![제 1 정규형의 예](/posts/20220830/1NF.png "제 1 정규형의 예"){: width="100%"}
...
- 제 2 정규형(2NF)
  ...
  >
  >![제 2 정규형의 예](/posts/20220830/2NF.png "제 2 정규형의 예"){: width="100%"}
...
- 제 3 정규형(3NF)
  ...
  >
  >![제 3 정규형의 예](/posts/20220830/3NF.png "제 3 정규형의 예"){: width="100%"}
...
- 보이스/코드 정규형(BCNF)
  ...
  >
  >![보이스/코드 정규형의 예](/posts/20220830/BCNF.png "보이스/코드 정규형의 예"){: width="100%"}
...
- 제 4 정규형(4NF)
  ...
  >
  >![제 4 정규형의 예](/posts/20220830/4NF.png "제 4 정규형의 예"){: width="100%"}
...
- 제 5 정규형(5NF)
  ...
  >
  >![제 5 정규형의 예](/posts/20220830/5NF.png "제 5 정규형의 예"){: width="100%"}
...
## 반정규화가 성능에 미치는 영향
### 성능이 향상 될 수 경우
![성능저하 정규화 모델의 예](/posts/20220830/example-of-a-degraded-regularization-model.png "성능저하 정규화 모델의 예"){: width="100%"}
...
![성능개선된 반정규화 모델 예시](/posts/20220830/example-of-performance-improvement-of-semi-normalized-model.png "성능개선된 반정규화 모델 예시"){: width="100%"}
...
![정규화한 모델 예시](/posts/20220830/normalized-model-example.png "정규화한 모델 예시"){: width="100%"}
...
![반정규화한 모델 예시](/posts/20220830/semi-normalized-model-example.png "반정규화한 모델 예시"){: width="100%"}
