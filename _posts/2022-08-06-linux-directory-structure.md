...
date: 2022-08-06
categories: [Linux]
tags: [linux, 리눅스, directory, 디렉토리, directory structrue, 디렉토리 구조]
pin: false
math: true
mermaid: true
image:
...
[심볼릭 링크](https://enxec.techblog.nbyte.kr/post/linux/what-is-inode-&-link/)를 생성해서 관리하고 있다.

![레드햇 계열 리눅스의 디렉토리 동향](/posts/20220806/directory-trend.png "레드햇 계열 리눅스의 디렉토리 동향"){: width="100%"}
