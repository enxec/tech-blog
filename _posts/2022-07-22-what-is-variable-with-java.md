...
tags: [java, 자바, 변수, variable, 멤버 변수, 클래스 변수, 인스턴스 변수, 지역 변수]
pin: false
math: true
mermaid: true
image:
...
![변수](/posts/20220722/variable.png "변수"){: width="100%"}
...
[데이터타입 (with.자바) - WONMO LEE's TECH BLOG](https://enxec.techblog.nbyte.kr/java/what-is-variable-type-with-java)
...
![자바 예약어](/posts/20220722/java-reserved-word.png "자바 예약어"){: width="100%"}
