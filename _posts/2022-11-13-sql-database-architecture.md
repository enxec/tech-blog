...
tags: [sql, Database Architecture, 데이터베이스 아키텍처]
pin: false
math: true
mermaid: true
image:
...
![Oracle Architecture](/posts/20221113/oracle-architecture.png "Oracle Architecture"){: width="100%"}
...
#### 전용 서버 방식
![전용 서버 방식](/posts/20221113/dedicated-server-method.png "전용 서버 방식"){: width="100%"}
...
![공유 서버 방식](/posts/20221113/shared-server-method.png "공유 서버 방식"){: width="100%"}
...
### 데이터 파일
![오라클 데이터 파일 구조](/posts/20221113/data-file-structure.png "오라클 데이터 파일 구조"){: width="100%"}
...
![오라클 저장 구조](/posts/20221113/oracle-save-structure.png "오라클 저장 구조"){: width="100%"}
...
![LRU list](/posts/20221113/lru-list.png "LRU list"){: width="100%"}
