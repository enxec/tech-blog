...
image:
  ...
  alt: 
---
![JDK & JRE & JVM](/posts/20220626/jdk-jre.png "JDK & JRE & JVM"){: width="100%"}
...
![JDK & JRE Detail Structure](/posts/20220626/jdk-jre-structure.png "JDK & JRE Detail Structure"){: width="100%"}
...
![일반프로그램과 자바프로그램 실행 프로세스 비교](/posts/20220626/general-java-compare.png "일반프로그램과 자바프로그램 실행 프로세스 비교"){: width="100%"}
...
![JVM은 각각의 OS에 맞는 버전이 필요하다.](/posts/20220626/java-os-relation.png "JVM은 각각의 OS에 맞는 버전이 필요하다."){: width="100%"}
...
## JVM 구조
---
![JVM Structure](/posts/20220626/jvm-structure.png "JVM Structure"){: width="100%"}
...
- 런타임 데이터 영역
    ...
    ![Runtime Area](/posts/20220626/runtime-area.png "Runtime Area"){: width="100%"}
    ...
    - Heap
        ...
        ![Heap Structure](/posts/20220626/heap-structure.jpg "Heap Structure"){: width="100%"}
