...
![WHERE절 예제](/assets/img/posts/20221004/query-example.png "WHERE절 예제"){: width="100%"}
...
- BETWEEN A AND B
  ...
  ![BETWEEN 예제](/assets/img/posts/20221004/query-example2.png "BETWEEN 예제"){: width="100%"}
...
- IN (list)
  ...
  ![IN 예제](/assets/img/posts/20221004/query-example3.png "IN 예제"){: width="100%"}
...
- LIKE '비교문자열'
  ...
  ![LIKE 예제](/assets/img/posts/20221004/query-example4.png "LIKE 예제"){: width="100%"}
...
- IS NULL
  ...
  ![IS NULL 예제](/assets/img/posts/20221004/query-example5.png "IS NULL 예제"){: width="100%"}
...
- OR
  ...
  ![LIKE 예제](/assets/img/posts/20221004/query-example2.png "LIKE 예제"){: width="100%"}
...
- NOT
  ...
  ![LIKE 예제](/assets/img/posts/20221004/query-example6.png "LIKE 예제"){: width="100%"}
