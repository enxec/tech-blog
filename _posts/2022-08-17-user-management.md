...
date: 2022-08-17
categories: [Linux]
tags: [linux, 리눅스, 사용자 관리, User Management]
pin: false
math: true
mermaid: true
image:
...
![리눅스 사용자 예시](/posts/20220817/linux-user.png "리눅스 사용자 예시"){: width="100%"}
<div style="color: gray; text-align: center; margin-bottom: 30px;">리눅스 사용자 예시</div>
<br>
![윈도우 사용자 예시](/posts/20220817/window-user.png "윈도우 사용자 예시"){: width="100%"}
