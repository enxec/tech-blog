...
tags: [spring, 스프링, framework, 프레임워크]
pin: false
math: true
mermaid: true
image:
...
![EJB](/posts/20220621/EJB-Structure.png "EJB"){: width="100%"}
...
![로드존슨의 J2EE 설계와 개발(expert one-on-one)](/posts/20220621/Rod-Johnson-J2EE-expert-dev.jpg "로드존슨의 J2EE 설계와 개발(expert one-on-one)"){: width="100%"}
...
## 스프링의 정의
---
![Spring](/posts/20220621/spring-logo2.png "Spring"){: width="100%"}
...
![Spring Ecosystem](/posts/20220621/spring-ecosystem.png "Spring Ecosystem"){: width="100%"}
